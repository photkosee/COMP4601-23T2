...
// ==============================================================
#ifndef __cordic_mul_mul_13cud__HH__
#define __cordic_mul_mul_13cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_mul_mul_13cud) {
    ...
    SC_CTOR(cordic_mul_mul_13cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
