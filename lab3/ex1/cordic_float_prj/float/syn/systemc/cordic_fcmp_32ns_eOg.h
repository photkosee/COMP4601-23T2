...
// ==============================================================
#ifndef __cordic_fcmp_32ns_eOg__HH__
#define __cordic_fcmp_32ns_eOg__HH__
#include "ACMP_fcmp.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_fcmp_32ns_eOg) {
    ...
    SC_CTOR(cordic_fcmp_32ns_eOg):  ACMP_fcmp_U ("ACMP_fcmp_U") {
        ACMP_fcmp_U.clk(clk);
