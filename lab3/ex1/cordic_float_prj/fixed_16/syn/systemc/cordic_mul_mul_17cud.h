...
// ==============================================================
#ifndef __cordic_mul_mul_17cud__HH__
#define __cordic_mul_mul_17cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cordic_mul_mul_17cud) {
    ...
    SC_CTOR(cordic_mul_mul_17cud):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
