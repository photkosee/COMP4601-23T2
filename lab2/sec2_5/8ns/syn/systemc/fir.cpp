...
void fir::thread_acc_fu_178_p2() {
    acc_fu_178_p2 = (!p_pn_reg_118.read().is_01() || !acc_0_reg_93.read().is_01())? sc_lv<32>(): (sc_biguint<32>(p_pn_reg_118.read()) + sc_biguint<32>(acc_0_reg_93.read()));
}
