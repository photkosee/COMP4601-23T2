...
always @ (posedge ap_clk) begin
    if (((icmp_ln17_reg_198 == 1'd0) & (1'b1 == ap_CS_fsm_state3))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        zext_ln21_1_reg_207[31 : 0] <= zext_ln21_1_fu_163_p1[31 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        shift_reg_address0 = zext_ln21_1_reg_207;
    end else if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (*) begin
    if ((((icmp_ln17_reg_198 == 1'd0) & (1'b1 == ap_CS_fsm_state3)) | ((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2)))) begin
        shift_reg_we0 = 1'b1;
    end else begin
        shift_reg_we0 = 1'b0;
    end
...
always @ (posedge ap_clk) begin
    zext_ln21_1_reg_207[63:32] <= 32'b00000000000000000000000000000000;
end
