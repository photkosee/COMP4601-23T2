...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_acc_fu_178_p2);
    ...
    sensitive << ( icmp_ln17_reg_197 );
    sensitive << ( mul_ln22_reg_216 );
    ...
    sc_trace(mVcdFile, mul_ln18_reg_189, "mul_ln18_reg_189");
    sc_trace(mVcdFile, icmp_ln17_fu_152_p2, "icmp_ln17_fu_152_p2");
    sc_trace(mVcdFile, icmp_ln17_reg_197, "icmp_ln17_reg_197");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_fu_144_p3, "tmp_fu_144_p3");
    sc_trace(mVcdFile, zext_ln21_1_fu_163_p1, "zext_ln21_1_fu_163_p1");
    sc_trace(mVcdFile, zext_ln21_1_reg_206, "zext_ln21_1_reg_206");
    sc_trace(mVcdFile, mul_ln22_fu_172_p2, "mul_ln22_fu_172_p2");
    sc_trace(mVcdFile, mul_ln22_reg_216, "mul_ln22_reg_216");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, acc_fu_178_p2, "acc_fu_178_p2");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        acc_0_reg_93 = acc_fu_178_p2.read();
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln17_fu_152_p2.read(), ap_const_lv1_0))) {
        zext_ln21_1_reg_206 = zext_ln21_1_fu_163_p1.read();
    }
}

void fir::thread_acc_fu_178_p2() {
    acc_fu_178_p2 = (!ap_phi_mux_p_pn_phi_fu_121_p4.read().is_01() || !acc_0_reg_93.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_phi_mux_p_pn_phi_fu_121_p4.read()) + sc_biguint<32>(acc_0_reg_93.read()));
}
...
void fir::thread_ap_phi_mux_p_pn_phi_fu_121_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && 
         esl_seteq<1,1,1>(icmp_ln17_reg_197.read(), ap_const_lv1_0))) {
        ap_phi_mux_p_pn_phi_fu_121_p4 = mul_ln22_reg_216.read();
    } else {
...
void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln21_1_reg_206.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln17_fu_152_p2.read(), ap_const_lv1_1))) {
