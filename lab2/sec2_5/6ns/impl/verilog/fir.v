...
(* CORE_GENERATION_INFO="fir,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xqzu5ev-ffrb900-1-i,HLS_INPUT_CLOCK=6.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=5.232000,HLS_SYN_LAT=34,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=244,HLS_SYN_LUT=227,HLS_VERSION=2020_1}" *)
...
always @ (posedge ap_clk) begin
    if (((icmp_ln17_reg_197 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
assign acc_fu_178_p2 = (ap_phi_mux_p_pn_phi_fu_121_p4 + acc_0_reg_93);
