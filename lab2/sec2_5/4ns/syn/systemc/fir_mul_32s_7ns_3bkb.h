...
// ==============================================================
#ifndef __fir_mul_32s_7ns_3bkb__HH__
#define __fir_mul_32s_7ns_3bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_mul_32s_7ns_3bkb) {
    ...
    SC_CTOR(fir_mul_32s_7ns_3bkb):  ACMP_mul_su_U ("ACMP_mul_su_U") {
