...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    c1_U->ce0(c1_ce0);
    c1_U->q0(c1_q0);
    fir_mul_32s_7ns_3bkb_U1 = new fir_mul_32s_7ns_3bkb<1,2,32,7,32>("fir_mul_32s_7ns_3bkb_U1");
    ...
    fir_mul_32s_10s_3cud_U2 = new fir_mul_32s_10s_3cud<1,2,32,10,32>("fir_mul_32s_10s_3cud_U2");
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln17_fu_152_p2.read(), ap_const_lv1_0))) {
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 2 : 
            ...
            break;
        case 4 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln17_fu_152_p2.read(), ap_const_lv1_1))) {
