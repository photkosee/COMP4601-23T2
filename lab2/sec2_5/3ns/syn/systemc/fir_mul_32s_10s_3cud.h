...
// ==============================================================
#ifndef __fir_mul_32s_10s_3cud__HH__
#define __fir_mul_32s_10s_3cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fir_mul_32s_10s_3cud) {
    ...
    SC_CTOR(fir_mul_32s_10s_3cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
