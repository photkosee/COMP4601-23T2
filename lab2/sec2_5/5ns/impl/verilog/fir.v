...
(* CORE_GENERATION_INFO="fir,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xqzu5ev-ffrb900-1-i,HLS_INPUT_CLOCK=5.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.880000,HLS_SYN_LAT=34,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=287,HLS_SYN_LUT=233,HLS_VERSION=2020_1}" *)
...
reg   [63:0] zext_ln21_1_reg_204;
reg  signed [31:0] shift_reg_load_reg_214;
wire    ap_CS_fsm_state3;
reg   [9:0] c1_load_reg_219;
wire   [31:0] mul_ln22_fu_171_p2;
reg   [31:0] mul_ln22_reg_224;
...
wire  signed [9:0] mul_ln22_fu_171_p1;
reg   [4:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        zext_ln21_1_reg_204[31 : 0] <= zext_ln21_1_fu_163_p1[31 : 0];
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state3)) begin
        shift_reg_address0 = zext_ln21_1_reg_204;
    end else if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign mul_ln22_fu_171_p1 = c1_load_reg_219;

assign mul_ln22_fu_171_p2 = ($signed(shift_reg_load_reg_214) * $signed(mul_ln22_fu_171_p1));
...
always @ (posedge ap_clk) begin
    zext_ln21_1_reg_204[63:32] <= 32'b00000000000000000000000000000000;
end
