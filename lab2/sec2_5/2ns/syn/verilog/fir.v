...
(* CORE_GENERATION_INFO="fir,hls_ip_2020_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xqzu5ev-ffrb900-1-i,HLS_INPUT_CLOCK=2.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.667750,HLS_SYN_LAT=84,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=4,HLS_SYN_FF=799,HLS_SYN_LUT=282,HLS_VERSION=2020_1}" *)
...
reg   [31:0] mul_ln18_reg_188;
wire    ap_CS_fsm_state7;
wire   [0:0] icmp_ln17_fu_152_p2;
reg   [0:0] icmp_ln17_reg_196;
wire    ap_CS_fsm_state8;
wire   [0:0] tmp_fu_144_p3;
wire   [63:0] zext_ln21_1_fu_163_p1;
reg   [63:0] zext_ln21_1_reg_205;
reg  signed [31:0] shift_reg_load_reg_215;
wire    ap_CS_fsm_state9;
reg  signed [9:0] c1_load_reg_220;
wire    ap_CS_fsm_state10;
wire   [31:0] grp_fu_171_p2;
reg   [31:0] mul_ln22_reg_230;
...
always @ (posedge ap_clk) begin
    if (((icmp_ln17_reg_196 == 1'd0) & (1'b1 == ap_CS_fsm_state17))) begin
        p_pn_reg_118 <= mul_ln22_reg_230;
    end else if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_144_p3 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (posedge ap_clk) begin
    if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
        zext_ln21_1_reg_205[31 : 0] <= zext_ln21_1_fu_163_p1[31 : 0];
    end
end

always @ (*) begin
    if (((tmp_fu_144_p3 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_state9)) begin
        shift_reg_address0 = zext_ln21_1_reg_205;
    end else if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8))) begin
        shift_reg_address0 = 4'd0;
    end else if (((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | ((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state8)) | ((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8)))) begin
        shift_reg_ce0 = 1'b1;
    end else begin
        shift_reg_ce0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state9) | ((tmp_fu_144_p3 == 1'd0) & (icmp_ln17_fu_152_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state8)))) begin
        shift_reg_we0 = 1'b1;
    end else begin
        shift_reg_we0 = 1'b0;
    end
...
assign acc_fu_176_p2 = (p_pn_reg_118 + acc_0_reg_93);
...
always @ (posedge ap_clk) begin
    zext_ln21_1_reg_205[63:32] <= 32'b00000000000000000000000000000000;
end
