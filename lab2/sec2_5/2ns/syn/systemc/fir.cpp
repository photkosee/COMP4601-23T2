...
const sc_lv<18> fir::ap_ST_fsm_state1 = "1";
const sc_lv<18> fir::ap_ST_fsm_state2 = "10";
const sc_lv<18> fir::ap_ST_fsm_state3 = "100";
const sc_lv<18> fir::ap_ST_fsm_state4 = "1000";
const sc_lv<18> fir::ap_ST_fsm_state5 = "10000";
const sc_lv<18> fir::ap_ST_fsm_state6 = "100000";
const sc_lv<18> fir::ap_ST_fsm_state7 = "1000000";
const sc_lv<18> fir::ap_ST_fsm_state8 = "10000000";
const sc_lv<18> fir::ap_ST_fsm_state9 = "100000000";
const sc_lv<18> fir::ap_ST_fsm_state10 = "1000000000";
const sc_lv<18> fir::ap_ST_fsm_state11 = "10000000000";
const sc_lv<18> fir::ap_ST_fsm_state12 = "100000000000";
const sc_lv<18> fir::ap_ST_fsm_state13 = "1000000000000";
const sc_lv<18> fir::ap_ST_fsm_state14 = "10000000000000";
const sc_lv<18> fir::ap_ST_fsm_state15 = "100000000000000";
const sc_lv<18> fir::ap_ST_fsm_state16 = "1000000000000000";
const sc_lv<18> fir::ap_ST_fsm_state17 = "10000000000000000";
const sc_lv<18> fir::ap_ST_fsm_state18 = "100000000000000000";
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state17.read())) {
        i_reg_235 = grp_fu_127_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0))) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln17_fu_152_p2.read(), ap_const_lv1_0))) {
        zext_ln21_1_reg_205 = zext_ln21_1_fu_163_p1.read();
    }
}

void fir::thread_acc_fu_176_p2() {
    acc_fu_176_p2 = (!p_pn_reg_118.read().is_01() || !acc_0_reg_93.read().is_01())? sc_lv<32>(): (sc_biguint<32>(p_pn_reg_118.read()) + sc_biguint<32>(acc_0_reg_93.read()));
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 64 : 
            ...
            break;
        case 128 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state8.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln17_fu_152_p2.read(), ap_const_lv1_1))) {
