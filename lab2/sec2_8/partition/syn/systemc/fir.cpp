...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_acc_fu_199_p2);
    sensitive << ( acc_0_reg_119 );
    sensitive << ( mul_ln25_fu_193_p2 );
    ...
    SC_METHOD(thread_mul_ln25_fu_193_p0);
    sensitive << ( shift_reg_q0 );
    sensitive << ( ap_CS_fsm_state5 );

    SC_METHOD(thread_mul_ln25_fu_193_p1);
    sensitive << ( c1_q0 );
    sensitive << ( ap_CS_fsm_state5 );

    SC_METHOD(thread_mul_ln25_fu_193_p2);
    sensitive << ( mul_ln25_fu_193_p0 );
    sensitive << ( mul_ln25_fu_193_p1 );

    SC_METHOD(thread_sext_ln24_fu_165_p1);
    sensitive << ( i_1_reg_132 );
    ...
    sensitive << ( zext_ln18_fu_155_p1 );
    sensitive << ( zext_ln18_1_fu_160_p1 );
    sensitive << ( zext_ln25_fu_177_p1 );
    ...
    SC_METHOD(thread_zext_ln18_1_fu_160_p1);
    sensitive << ( i_0_reg_107 );

    SC_METHOD(thread_zext_ln18_fu_155_p1);
    sensitive << ( i_fu_149_p2 );

    SC_METHOD(thread_zext_ln25_fu_177_p1);
    sensitive << ( sext_ln24_fu_165_p1 );
    ...
    sc_trace(mVcdFile, i_2_reg_236, "i_2_reg_236");
    sc_trace(mVcdFile, acc_fu_199_p2, "acc_fu_199_p2");
    sc_trace(mVcdFile, ap_CS_fsm_state5, "ap_CS_fsm_state5");
    sc_trace(mVcdFile, i_0_reg_107, "i_0_reg_107");
    sc_trace(mVcdFile, ap_CS_fsm_state3, "ap_CS_fsm_state3");
    sc_trace(mVcdFile, acc_0_reg_119, "acc_0_reg_119");
    sc_trace(mVcdFile, i_1_reg_132, "i_1_reg_132");
    sc_trace(mVcdFile, zext_ln18_fu_155_p1, "zext_ln18_fu_155_p1");
    sc_trace(mVcdFile, zext_ln18_1_fu_160_p1, "zext_ln18_1_fu_160_p1");
    sc_trace(mVcdFile, zext_ln25_fu_177_p1, "zext_ln25_fu_177_p1");
    sc_trace(mVcdFile, sext_ln24_fu_165_p1, "sext_ln24_fu_165_p1");
    sc_trace(mVcdFile, mul_ln25_fu_193_p0, "mul_ln25_fu_193_p0");
    sc_trace(mVcdFile, mul_ln25_fu_193_p1, "mul_ln25_fu_193_p1");
    sc_trace(mVcdFile, mul_ln25_fu_193_p2, "mul_ln25_fu_193_p2");
...
void fir::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        acc_0_reg_119 = acc_fu_199_p2.read();
    ...
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        i_0_reg_107 = i_reg_213.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
                esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        i_0_reg_107 = ap_const_lv4_A;
    }
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state5.read())) {
        i_1_reg_132 = i_2_reg_236.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln17_fu_143_p2.read(), ap_const_lv1_1))) {
        i_1_reg_132 = ap_const_lv5_A;
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(ap_const_lv1_0, tmp_fu_169_p3.read()))) {
        i_2_reg_236 = i_2_fu_183_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(icmp_ln17_fu_143_p2.read(), ap_const_lv1_0))) {
        i_reg_213 = i_fu_149_p2.read();
    }
}

void fir::thread_acc_fu_199_p2() {
    acc_fu_199_p2 = (!mul_ln25_fu_193_p2.read().is_01() || !acc_0_reg_119.read().is_01())? sc_lv<32>(): (sc_biguint<32>(mul_ln25_fu_193_p2.read()) + sc_biguint<32>(acc_0_reg_119.read()));
}
...
void fir::thread_c1_address0() {
    c1_address0 =  (sc_lv<4>) (zext_ln25_fu_177_p1.read());
}
...
void fir::thread_i_2_fu_183_p2() {
    i_2_fu_183_p2 = (!i_1_reg_132.read().is_01() || !ap_const_lv5_1F.is_01())? sc_lv<5>(): (sc_bigint<5>(i_1_reg_132.read()) + sc_bigint<5>(ap_const_lv5_1F));
}

void fir::thread_i_fu_149_p2() {
    i_fu_149_p2 = (!i_0_reg_107.read().is_01() || !ap_const_lv4_F.is_01())? sc_lv<4>(): (sc_biguint<4>(i_0_reg_107.read()) + sc_bigint<4>(ap_const_lv4_F));
}

void fir::thread_icmp_ln17_fu_143_p2() {
    icmp_ln17_fu_143_p2 = (!i_0_reg_107.read().is_01() || !ap_const_lv4_0.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_107.read() == ap_const_lv4_0);
}

void fir::thread_mul_ln25_fu_193_p0() {
    mul_ln25_fu_193_p0 = shift_reg_q0.read();
}

void fir::thread_mul_ln25_fu_193_p1() {
    mul_ln25_fu_193_p1 = c1_q0.read();
}

void fir::thread_mul_ln25_fu_193_p2() {
    mul_ln25_fu_193_p2 = (!mul_ln25_fu_193_p0.read().is_01() || !mul_ln25_fu_193_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln25_fu_193_p0.read()) * sc_bigint<10>(mul_ln25_fu_193_p1.read());
}

void fir::thread_sext_ln24_fu_165_p1() {
    sext_ln24_fu_165_p1 = esl_sext<32,5>(i_1_reg_132.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read())) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln25_fu_177_p1.read());
    } else if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln18_1_fu_160_p1.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln17_fu_143_p2.read(), ap_const_lv1_1))) {
        shift_reg_address0 = ap_const_lv4_0;
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(icmp_ln17_fu_143_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln18_fu_155_p1.read());
    } else {
...
void fir::thread_tmp_fu_169_p3() {
    tmp_fu_169_p3 = i_1_reg_132.read().range(4, 4);
}

void fir::thread_y() {
    y = acc_0_reg_119.read();
}
...
void fir::thread_zext_ln18_1_fu_160_p1() {
    zext_ln18_1_fu_160_p1 = esl_zext<64,4>(i_0_reg_107.read());
}

void fir::thread_zext_ln18_fu_155_p1() {
    zext_ln18_fu_155_p1 = esl_zext<64,4>(i_fu_149_p2.read());
}

void fir::thread_zext_ln25_fu_177_p1() {
    zext_ln25_fu_177_p1 = esl_zext<64,32>(sext_ln24_fu_165_p1.read());
}
...
void fir::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        ...
        case 4 : 
            ...
            break;
        case 8 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state4.read()) && esl_seteq<1,1,1>(tmp_fu_169_p3.read(), ap_const_lv1_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
