...
fir::fir(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    sensitive << ( icmp_ln29_reg_198 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( p_pn_reg_118 );
    sensitive << ( mul_ln34_fu_172_p2 );
    ...
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( zext_ln33_1_fu_163_p1 );
    ...
    SC_METHOD(thread_icmp_ln29_fu_152_p2);
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_fu_144_p3 );
    sensitive << ( i_0_reg_106 );

    SC_METHOD(thread_mul_ln30_fu_134_p0);
    sensitive << ( ap_CS_fsm_state1 );
    sensitive << ( x );

    SC_METHOD(thread_mul_ln30_fu_134_p2);
    sensitive << ( mul_ln30_fu_134_p0 );

    SC_METHOD(thread_mul_ln34_fu_172_p0);
    sensitive << ( shift_reg_q0 );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_mul_ln34_fu_172_p1);
    sensitive << ( c1_q0 );
    sensitive << ( ap_CS_fsm_state3 );

    SC_METHOD(thread_mul_ln34_fu_172_p2);
    sensitive << ( mul_ln34_fu_172_p0 );
    sensitive << ( mul_ln34_fu_172_p1 );

    SC_METHOD(thread_sext_ln28_fu_140_p1);
    sensitive << ( i_0_reg_106 );

    SC_METHOD(thread_shift_reg_address0);
    sensitive << ( icmp_ln29_fu_152_p2 );
    sensitive << ( ap_CS_fsm_state2 );
    sensitive << ( tmp_fu_144_p3 );
    sensitive << ( zext_ln33_1_reg_207 );
    sensitive << ( ap_CS_fsm_state3 );
    sensitive << ( zext_ln33_fu_158_p1 );
    ...
    SC_METHOD(thread_zext_ln33_1_fu_163_p1);
    sensitive << ( sext_ln28_fu_140_p1 );

    SC_METHOD(thread_zext_ln33_fu_158_p1);
    ...
    sc_trace(mVcdFile, mul_ln30_fu_134_p2, "mul_ln30_fu_134_p2");
    sc_trace(mVcdFile, mul_ln30_reg_190, "mul_ln30_reg_190");
    sc_trace(mVcdFile, icmp_ln29_fu_152_p2, "icmp_ln29_fu_152_p2");
    sc_trace(mVcdFile, icmp_ln29_reg_198, "icmp_ln29_reg_198");
    sc_trace(mVcdFile, ap_CS_fsm_state2, "ap_CS_fsm_state2");
    sc_trace(mVcdFile, tmp_fu_144_p3, "tmp_fu_144_p3");
    sc_trace(mVcdFile, zext_ln33_1_fu_163_p1, "zext_ln33_1_fu_163_p1");
    sc_trace(mVcdFile, zext_ln33_1_reg_207, "zext_ln33_1_reg_207");
    ...
    sc_trace(mVcdFile, mul_ln34_fu_172_p2, "mul_ln34_fu_172_p2");
    sc_trace(mVcdFile, zext_ln33_fu_158_p1, "zext_ln33_fu_158_p1");
    sc_trace(mVcdFile, grp_fu_127_p0, "grp_fu_127_p0");
    sc_trace(mVcdFile, mul_ln30_fu_134_p0, "mul_ln30_fu_134_p0");
    sc_trace(mVcdFile, sext_ln28_fu_140_p1, "sext_ln28_fu_140_p1");
    sc_trace(mVcdFile, mul_ln34_fu_172_p0, "mul_ln34_fu_172_p0");
    sc_trace(mVcdFile, mul_ln34_fu_172_p1, "mul_ln34_fu_172_p1");
...
void fir::thread_ap_clk_no_reset_() {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(icmp_ln29_reg_198.read(), ap_const_lv1_0))) {
        p_pn_reg_118 = mul_ln34_fu_172_p2.read();
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln29_fu_152_p2.read(), ap_const_lv1_1))) {
        p_pn_reg_118 = mul_ln30_reg_190.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0))) {
        icmp_ln29_reg_198 = icmp_ln29_fu_152_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && esl_seteq<1,1,1>(ap_start.read(), ap_const_logic_1))) {
        mul_ln30_reg_190 = mul_ln30_fu_134_p2.read();
    }
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && esl_seteq<1,1,1>(icmp_ln29_fu_152_p2.read(), ap_const_lv1_0))) {
        zext_ln33_1_reg_207 = zext_ln33_1_fu_163_p1.read();
    }
}
...
void fir::thread_ap_phi_mux_p_pn_phi_fu_121_p4() {
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read()) && 
         esl_seteq<1,1,1>(icmp_ln29_reg_198.read(), ap_const_lv1_0))) {
        ap_phi_mux_p_pn_phi_fu_121_p4 = mul_ln34_fu_172_p2.read();
    } else {
...
void fir::thread_c1_address0() {
    c1_address0 =  (sc_lv<4>) (zext_ln33_1_fu_163_p1.read());
}
...
void fir::thread_icmp_ln29_fu_152_p2() {
    icmp_ln29_fu_152_p2 = (!i_0_reg_106.read().is_01() || !ap_const_lv5_0.is_01())? sc_lv<1>(): sc_lv<1>(i_0_reg_106.read() == ap_const_lv5_0);
}

void fir::thread_mul_ln30_fu_134_p0() {
    mul_ln30_fu_134_p0 = x.read();
}

void fir::thread_mul_ln30_fu_134_p2() {
    mul_ln30_fu_134_p2 = (!mul_ln30_fu_134_p0.read().is_01() || !ap_const_lv32_35.is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln30_fu_134_p0.read()) * sc_biguint<32>(ap_const_lv32_35);
}

void fir::thread_mul_ln34_fu_172_p0() {
    mul_ln34_fu_172_p0 = shift_reg_q0.read();
}

void fir::thread_mul_ln34_fu_172_p1() {
    mul_ln34_fu_172_p1 = c1_q0.read();
}

void fir::thread_mul_ln34_fu_172_p2() {
    mul_ln34_fu_172_p2 = (!mul_ln34_fu_172_p0.read().is_01() || !mul_ln34_fu_172_p1.read().is_01())? sc_lv<32>(): sc_bigint<32>(mul_ln34_fu_172_p0.read()) * sc_bigint<10>(mul_ln34_fu_172_p1.read());
}

void fir::thread_sext_ln28_fu_140_p1() {
    sext_ln28_fu_140_p1 = esl_sext<32,5>(i_0_reg_106.read());
}

void fir::thread_shift_reg_address0() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state3.read())) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln33_1_reg_207.read());
    } else if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && 
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln29_fu_152_p2.read(), ap_const_lv1_1))) {
        shift_reg_address0 = ap_const_lv4_0;
                ...
                esl_seteq<1,1,1>(tmp_fu_144_p3.read(), ap_const_lv1_0) && 
                esl_seteq<1,1,1>(icmp_ln29_fu_152_p2.read(), ap_const_lv1_0))) {
        shift_reg_address0 =  (sc_lv<4>) (zext_ln33_fu_158_p1.read());
    } else {
...
void fir::thread_zext_ln33_1_fu_163_p1() {
    zext_ln33_1_fu_163_p1 = esl_zext<64,32>(sext_ln28_fu_140_p1.read());
}

void fir::thread_zext_ln33_fu_158_p1() {
    zext_ln33_fu_158_p1 = esl_zext<64,5>(grp_fu_127_p2.read());
}
