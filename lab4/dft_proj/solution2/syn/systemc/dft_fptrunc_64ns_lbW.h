...
// ==============================================================
#ifndef __dft_fptrunc_64ns_lbW__HH__
#define __dft_fptrunc_64ns_lbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_fptrunc_64ns_lbW) {
    ...
    SC_CTOR(dft_fptrunc_64ns_lbW):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
