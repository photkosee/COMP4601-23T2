...
// ==============================================================
#ifndef __dft_fpext_32ns_64mb6__HH__
#define __dft_fpext_32ns_64mb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_fpext_32ns_64mb6) {
    ...
    SC_CTOR(dft_fpext_32ns_64mb6):  ACMP_fpext_U ("ACMP_fpext_U") {
