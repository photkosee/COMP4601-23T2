...
// ==============================================================
#ifndef __dft_sitodp_32ns_6ocq__HH__
#define __dft_sitodp_32ns_6ocq__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_sitodp_32ns_6ocq) {
    ...
    SC_CTOR(dft_sitodp_32ns_6ocq):  ACMP_sitodp_U ("ACMP_sitodp_U") {
