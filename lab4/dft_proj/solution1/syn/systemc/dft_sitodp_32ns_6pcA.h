...
// ==============================================================
#ifndef __dft_sitodp_32ns_6pcA__HH__
#define __dft_sitodp_32ns_6pcA__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_sitodp_32ns_6pcA) {
    ...
    SC_CTOR(dft_sitodp_32ns_6pcA):  ACMP_sitodp_U ("ACMP_sitodp_U") {
