...
// ==============================================================
#ifndef __dft_fptrunc_64ns_mb6__HH__
#define __dft_fptrunc_64ns_mb6__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_fptrunc_64ns_mb6) {
    ...
    SC_CTOR(dft_fptrunc_64ns_mb6):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
