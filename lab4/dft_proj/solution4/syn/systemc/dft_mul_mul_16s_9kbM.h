...
// ==============================================================
#ifndef __dft_mul_mul_16s_9kbM__HH__
#define __dft_mul_mul_16s_9kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_mul_16s_9kbM) {
    ...
    SC_CTOR(dft_mul_mul_16s_9kbM):  ACMP_smul_su_U ("ACMP_smul_su_U") {
