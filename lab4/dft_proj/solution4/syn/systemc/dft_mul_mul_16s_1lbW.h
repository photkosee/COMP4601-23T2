...
// ==============================================================
#ifndef __dft_mul_mul_16s_1lbW__HH__
#define __dft_mul_mul_16s_1lbW__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_mul_16s_1lbW) {
    ...
    SC_CTOR(dft_mul_mul_16s_1lbW):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
