...
// ==============================================================
#ifndef __dft_mul_mul_16s_1kbM__HH__
#define __dft_mul_mul_16s_1kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mul_mul_16s_1kbM) {
    ...
    SC_CTOR(dft_mul_mul_16s_1kbM):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
