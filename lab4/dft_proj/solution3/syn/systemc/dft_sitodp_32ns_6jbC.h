...
// ==============================================================
#ifndef __dft_sitodp_32ns_6jbC__HH__
#define __dft_sitodp_32ns_6jbC__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_sitodp_32ns_6jbC) {
    ...
    SC_CTOR(dft_sitodp_32ns_6jbC):  ACMP_sitodp_U ("ACMP_sitodp_U") {
