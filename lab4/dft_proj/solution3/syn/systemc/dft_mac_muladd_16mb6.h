...
// ==============================================================
#ifndef __dft_mac_muladd_16mb6__HH__
#define __dft_mac_muladd_16mb6__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(dft_mac_muladd_16mb6) {
    ...
    SC_CTOR(dft_mac_muladd_16mb6):  simcore_mac_1_U ("simcore_mac_1_U") {
