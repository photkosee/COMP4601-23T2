...
set C_modelArgList {
	...
	{ OUT_R_V int 22 regular {array 1024 { 0 3 } 0 1 }  }
	{ OUT_I_V int 22 regular {array 1024 { 0 3 } 0 1 }  }
}
...
set Spec2ImplPortList { 
	X_R_V { ap_memory {  { X_R_V_address0 mem_address 1 10 }  { X_R_V_ce0 mem_ce 1 1 }  { X_R_V_q0 mem_dout 0 22 } } }
	X_I_V { ap_memory {  { X_I_V_address0 mem_address 1 10 }  { X_I_V_ce0 mem_ce 1 1 }  { X_I_V_q0 mem_dout 0 22 } } }
	OUT_R_V { ap_memory {  { OUT_R_V_address0 mem_address 1 10 }  { OUT_R_V_ce0 mem_ce 1 1 }  { OUT_R_V_we0 mem_we 1 1 }  { OUT_R_V_d0 mem_din 1 22 } } }
	OUT_I_V { ap_memory {  { OUT_I_V_address0 mem_address 1 10 }  { OUT_I_V_ce0 mem_ce 1 1 }  { OUT_I_V_we0 mem_we 1 1 }  { OUT_I_V_d0 mem_din 1 22 } } }
}
