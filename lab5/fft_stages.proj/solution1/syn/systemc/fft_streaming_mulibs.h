...
// ==============================================================
#ifndef __fft_streaming_mulibs__HH__
#define __fft_streaming_mulibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_mulibs) {
    ...
    SC_CTOR(fft_streaming_mulibs):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
