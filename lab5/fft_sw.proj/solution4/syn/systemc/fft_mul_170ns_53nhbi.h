...
// ==============================================================
#ifndef __fft_mul_170ns_53nhbi__HH__
#define __fft_mul_170ns_53nhbi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_mul_170ns_53nhbi) {
    ...
    SC_CTOR(fft_mul_170ns_53nhbi):  ACMP_mul_uu_U ("ACMP_mul_uu_U") {
