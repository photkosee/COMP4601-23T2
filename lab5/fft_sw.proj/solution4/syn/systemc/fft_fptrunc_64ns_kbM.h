...
// ==============================================================
#ifndef __fft_fptrunc_64ns_kbM__HH__
#define __fft_fptrunc_64ns_kbM__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_fptrunc_64ns_kbM) {
    ...
    SC_CTOR(fft_fptrunc_64ns_kbM):  ACMP_fptrunc_U ("ACMP_fptrunc_U") {
