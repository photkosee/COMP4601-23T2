...
// ==============================================================
#ifndef __fft_faddfsub_32nsibs__HH__
#define __fft_faddfsub_32nsibs__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_faddfsub_32nsibs) {
    ...
    SC_CTOR(fft_faddfsub_32nsibs):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
