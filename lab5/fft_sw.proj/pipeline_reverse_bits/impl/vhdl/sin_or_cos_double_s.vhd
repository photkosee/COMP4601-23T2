...
architecture behav of sin_or_cos_double_s is 
    ...
    signal tmp_1_fu_817_p4 : STD_LOGIC_VECTOR (36 downto 0);
    ...
    signal tmp_2_fu_937_p18 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_3_fu_975_p18 : STD_LOGIC_VECTOR (0 downto 0);
...
begin
    ...
    fft_mul_170ns_53nhbi_U7 : component fft_mul_170ns_53nhbi
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 170,
    ...
    fft_mux_83_1_1_1_U8 : component fft_mux_83_1_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    fft_mux_164_1_1_1_U9 : component fft_mux_164_1_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 1,
    ...
    select_ln271_fu_1013_p3 <= 
        tmp_2_fu_937_p18 when (cos_basis_reg_1305(0) = '1') else 
        tmp_3_fu_975_p18;
    ...
    tmp_1_fu_817_p4 <= r_V_25_fu_811_p2(74 downto 38);
    ...
    zext_ln657_fu_827_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_1_fu_817_p4),64));
