...
// ==============================================================
#ifndef __fft_fpext_32ns_64lbW__HH__
#define __fft_fpext_32ns_64lbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_fpext_32ns_64lbW) {
    ...
    SC_CTOR(fft_fpext_32ns_64lbW):  ACMP_fpext_U ("ACMP_fpext_U") {
