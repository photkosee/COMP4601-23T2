#ifndef FFT_H_
#define FFT_H_
#include "ap_fixed.h" /* uncomment to use fixed point DTYPE */

//typedef float DTYPE; /* comment to use fixed point DTYPE */
typedef ap_fixed<22,11> DTYPE;  /* uncomment to use fixed point DTYPE */
typedef int INTTYPE;
