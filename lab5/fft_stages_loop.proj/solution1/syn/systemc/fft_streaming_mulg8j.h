...
// ==============================================================
#ifndef __fft_streaming_mulg8j__HH__
#define __fft_streaming_mulg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_mulg8j) {
    ...
    SC_CTOR(fft_streaming_mulg8j):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
