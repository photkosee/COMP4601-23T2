...
// ==============================================================
#ifndef __fft_streaming_maczec__HH__
#define __fft_streaming_maczec__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_maczec) {
    ...
    SC_CTOR(fft_streaming_maczec):  simcore_mac_3_U ("simcore_mac_3_U") {
