...
// ==============================================================
#ifndef __fft_streaming_muldEe__HH__
#define __fft_streaming_muldEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_muldEe) {
    ...
    SC_CTOR(fft_streaming_muldEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
