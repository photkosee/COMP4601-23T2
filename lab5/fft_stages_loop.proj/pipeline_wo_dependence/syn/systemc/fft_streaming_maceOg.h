...
// ==============================================================
#ifndef __fft_streaming_maceOg__HH__
#define __fft_streaming_maceOg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_maceOg) {
    ...
    SC_CTOR(fft_streaming_maceOg):  simcore_mac_0_U ("simcore_mac_0_U") {
