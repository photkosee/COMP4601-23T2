...
// ==============================================================
#ifndef __fft_streaming_macfYi__HH__
#define __fft_streaming_macfYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_macfYi) {
    ...
    SC_CTOR(fft_streaming_macfYi):  simcore_mac_1_U ("simcore_mac_1_U") {
