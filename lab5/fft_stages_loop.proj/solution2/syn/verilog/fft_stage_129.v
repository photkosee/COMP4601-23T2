...
output   ap_idle;
output   ap_ready;
output  [9:0] X_R_3_V_address0;
output   X_R_3_V_ce0;
input  [21:0] X_R_3_V_q0;
output  [9:0] X_R_3_V_address1;
output   X_R_3_V_ce1;
input  [21:0] X_R_3_V_q1;
output  [9:0] X_I_3_V_address0;
output   X_I_3_V_ce0;
input  [21:0] X_I_3_V_q0;
output  [9:0] X_I_3_V_address1;
output   X_I_3_V_ce1;
input  [21:0] X_I_3_V_q1;
output  [9:0] Out_R_4_V_address0;
output   Out_R_4_V_ce0;
output   Out_R_4_V_we0;
output  [21:0] Out_R_4_V_d0;
output  [9:0] Out_R_4_V_address1;
output   Out_R_4_V_ce1;
output   Out_R_4_V_we1;
output  [21:0] Out_R_4_V_d1;
output  [9:0] Out_I_4_V_address0;
output   Out_I_4_V_ce0;
output   Out_I_4_V_we0;
output  [21:0] Out_I_4_V_d0;
output  [9:0] Out_I_4_V_address1;
output   Out_I_4_V_ce1;
output   Out_I_4_V_we1;
output  [21:0] Out_I_4_V_d1;
...
wire   [8:0] W_real_V56_address0;
reg    W_real_V56_ce0;
wire   [12:0] W_real_V56_q0;
wire   [8:0] W_imag_V48_address0;
reg    W_imag_V48_ce0;
wire   [11:0] W_imag_V48_q0;
...
wire   [3:0] select_ln47_15_fu_297_p3;
reg   [3:0] select_ln47_15_reg_447;
wire   [9:0] i_fu_309_p3;
reg   [9:0] i_reg_452;
wire   [63:0] zext_ln58_fu_323_p1;
reg   [63:0] zext_ln58_reg_457;
reg   [63:0] zext_ln58_reg_457_pp0_iter1_reg;
wire   [6:0] t_fu_328_p2;
reg   [12:0] W_real_V56_load_reg_474;
reg   [11:0] W_imag_V48_load_reg_479;
reg   [21:0] X_R_3_V_load_reg_484;
...
reg   [3:0] ap_phi_mux_j_0_phi_fu_209_p4;
wire    ap_block_pp0_stage0;
wire   [63:0] zext_ln47_fu_291_p1;
wire   [2:0] trunc_ln54_fu_227_p1;
wire   [0:0] icmp_ln50_fu_251_p2;
wire   [3:0] add_ln47_6_fu_265_p2;
wire   [2:0] trunc_ln54_6_fu_271_p1;
wire   [8:0] k_mid1_fu_275_p3;
wire   [8:0] k_fu_231_p3;
wire   [8:0] select_ln47_14_fu_283_p3;
wire   [6:0] select_ln47_fu_257_p3;
wire   [5:0] trunc_ln51_fu_305_p1;
...
wire  signed [32:0] sext_ln47_5_fu_342_p1;
wire  signed [21:0] grp_fu_404_p1;
wire  signed [32:0] sext_ln1118_9_fu_348_p1;
...
assign Out_I_4_V_address0 = zext_ln58_reg_457_pp0_iter1_reg;

assign Out_I_4_V_address1 = zext_ln60_reg_494;

assign Out_I_4_V_d0 = (X_I_3_V_q1 - temp_I_V_fu_361_p4);

assign Out_I_4_V_d1 = (temp_I_V_fu_361_p4 + X_I_3_V_q1);

assign Out_R_4_V_address0 = zext_ln58_reg_457_pp0_iter1_reg;

assign Out_R_4_V_address1 = zext_ln60_reg_494;

assign Out_R_4_V_d0 = (X_R_3_V_q1 - temp_R_V_fu_352_p4);

assign Out_R_4_V_d1 = (temp_R_V_fu_352_p4 + X_R_3_V_q1);

assign W_imag_V48_address0 = zext_ln47_fu_291_p1;

assign W_real_V56_address0 = zext_ln47_fu_291_p1;

assign X_I_3_V_address0 = zext_ln58_reg_457;

assign X_I_3_V_address1 = zext_ln60_fu_334_p1;

assign X_R_3_V_address0 = zext_ln58_fu_323_p1;

assign X_R_3_V_address1 = zext_ln60_fu_334_p1;

assign add_ln47_6_fu_265_p2 = (4'd1 + ap_phi_mux_j_0_phi_fu_209_p4);
...
assign grp_fu_404_p0 = sext_ln47_5_fu_342_p1;

assign grp_fu_404_p1 = sext_ln1118_9_fu_348_p1;

assign grp_fu_413_p0 = sext_ln47_fu_339_p1;

assign grp_fu_413_p1 = sext_ln1118_9_fu_348_p1;

assign i_fu_309_p3 = {{trunc_ln51_fu_305_p1}, {select_ln47_15_fu_297_p3}};

assign i_lower_fu_317_p2 = (10'd8 + i_fu_309_p3);

assign icmp_ln47_fu_239_p2 = ((indvar_flatten_reg_194 == 10'd512) ? 1'b1 : 1'b0);

assign icmp_ln50_fu_251_p2 = ((t_0_reg_216 == 7'd64) ? 1'b1 : 1'b0);

assign k_fu_231_p3 = {{trunc_ln54_fu_227_p1}, {6'd0}};

assign k_mid1_fu_275_p3 = {{trunc_ln54_6_fu_271_p1}, {6'd0}};

assign mul_ln1192_fu_421_p0 = sext_ln47_5_fu_342_p1;
...
assign select_ln47_14_fu_283_p3 = ((icmp_ln50_fu_251_p2[0:0] === 1'b1) ? k_mid1_fu_275_p3 : k_fu_231_p3);

assign select_ln47_15_fu_297_p3 = ((icmp_ln50_fu_251_p2[0:0] === 1'b1) ? add_ln47_6_fu_265_p2 : ap_phi_mux_j_0_phi_fu_209_p4);

assign select_ln47_fu_257_p3 = ((icmp_ln50_fu_251_p2[0:0] === 1'b1) ? 7'd0 : t_0_reg_216);

assign sext_ln1118_9_fu_348_p1 = $signed(X_I_3_V_q0);

assign sext_ln1118_fu_345_p1 = $signed(X_R_3_V_load_reg_484);

assign sext_ln47_5_fu_342_p1 = $signed(W_imag_V48_load_reg_479);

assign sext_ln47_fu_339_p1 = $signed(W_real_V56_load_reg_474);

assign t_fu_328_p2 = (7'd1 + select_ln47_fu_257_p3);

assign temp_I_V_fu_361_p4 = {{grp_fu_413_p3[32:11]}};

assign temp_R_V_fu_352_p4 = {{grp_fu_404_p3[32:11]}};

assign trunc_ln51_fu_305_p1 = select_ln47_fu_257_p3[5:0];

assign trunc_ln54_6_fu_271_p1 = add_ln47_6_fu_265_p2[2:0];

assign trunc_ln54_fu_227_p1 = ap_phi_mux_j_0_phi_fu_209_p4[2:0];

assign zext_ln47_fu_291_p1 = select_ln47_14_fu_283_p3;
