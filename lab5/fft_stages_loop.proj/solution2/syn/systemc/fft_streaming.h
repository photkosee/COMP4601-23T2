...
struct fft_streaming : public sc_module {
    ...
    fft_streaming_StaBew* Stage_R_1_V_U;
    fft_streaming_StaBew* Stage_R_2_V_U;
    fft_streaming_StaBew* Stage_R_3_V_U;
    fft_streaming_StaBew* Stage_R_4_V_U;
    fft_streaming_StaBew* Stage_R_5_V_U;
    fft_streaming_StaBew* Stage_R_6_V_U;
    fft_streaming_StaBew* Stage_R_7_V_U;
    fft_streaming_StaBew* Stage_R_8_V_U;
    fft_streaming_StaBew* Stage_R_9_V_U;
    fft_streaming_StaBew* Stage_I_0_V_U;
    fft_streaming_StaBew* Stage_I_1_V_U;
    fft_streaming_StaBew* Stage_I_2_V_U;
    fft_streaming_StaBew* Stage_I_3_V_U;
    fft_streaming_StaBew* Stage_I_4_V_U;
    fft_streaming_StaBew* Stage_I_5_V_U;
    fft_streaming_StaBew* Stage_I_6_V_U;
    fft_streaming_StaBew* Stage_I_7_V_U;
    fft_streaming_StaBew* Stage_I_8_V_U;
    fft_streaming_StaBew* Stage_I_9_V_U;
    ...
    sc_signal< sc_lv<10> > bit_reverse25_U0_OUT_R_V_address1;
    sc_signal< sc_logic > bit_reverse25_U0_OUT_R_V_ce1;
    sc_signal< sc_logic > bit_reverse25_U0_OUT_R_V_we1;
    sc_signal< sc_lv<22> > bit_reverse25_U0_OUT_R_V_d1;
    ...
    sc_signal< sc_lv<10> > bit_reverse25_U0_OUT_I_V_address1;
    sc_signal< sc_logic > bit_reverse25_U0_OUT_I_V_ce1;
    sc_signal< sc_logic > bit_reverse25_U0_OUT_I_V_we1;
    sc_signal< sc_lv<22> > bit_reverse25_U0_OUT_I_V_d1;
