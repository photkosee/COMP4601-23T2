...
// ==============================================================
#ifndef __fft_streaming_mulAem__HH__
#define __fft_streaming_mulAem__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_mulAem) {
    ...
    SC_CTOR(fft_streaming_mulAem):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
