...
// ==============================================================
#ifndef __fft_streaming_macyd2__HH__
#define __fft_streaming_macyd2__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(fft_streaming_macyd2) {
    ...
    SC_CTOR(fft_streaming_macyd2):  simcore_mac_2_U ("simcore_mac_2_U") {
